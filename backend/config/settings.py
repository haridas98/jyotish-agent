...
WITNESS_DASHA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_DASHA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "dasha-parity-report.json"),
)
WITNESS_PANCHANGA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_PANCHANGA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "panchanga-parity-report.json"),
)
WITNESS_ASHTAKAVARGA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_ASHTAKAVARGA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "ashtakavarga-parity-report.json"),
)
WITNESS_STRENGTHS_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_STRENGTHS_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "strengths-parity-report.json"),
)
WITNESS_YOGA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_YOGA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "yoga-parity-report.json"),
)
WITNESS_SPECIAL_POINTS_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_SPECIAL_POINTS_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "special-points-parity-report.json"),
)
WITNESS_ARGALA_PARITY_REPORT_PATH = os.getenv(
...
WITNESS_DRISHTI_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_DRISHTI_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "drishti-parity-report.json"),
)
WITNESS_TRANSIT_COORDINATE_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_TRANSIT_COORDINATE_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "transit-coordinate-parity-report.json"),
)
WITNESS_COMPATIBILITY_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_COMPATIBILITY_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "compatibility-parity-report.json"),
)
WITNESS_MUHURTA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_MUHURTA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "muhurta-parity-report.json"),
)
WITNESS_TITHI_PRAVESHA_PARITY_REPORT_PATH = os.getenv(
...
WITNESS_PRASHNA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_PRASHNA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "prashna-parity-report.json"),
)
WITNESS_JAIMINI_KARAKA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_JAIMINI_KARAKA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "jaimini-karaka-parity-report.json"),
)
WITNESS_JAIMINI_VARGA_PARITY_REPORT_PATH = os.getenv(
    "WITNESS_JAIMINI_VARGA_PARITY_REPORT_PATH",
    str(ROOT_DIR / ".tmp" / "witness-review" / "jaimini-varga-parity-report.json"),
)
