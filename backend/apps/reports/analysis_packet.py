...
def build_analysis_packet(
    ...
    packet = {
        ...
        "context": {
            ...
            "chart": chart,
            "selected_profile_context": data.get("selected_profile_context", {}),
            "related_profile_context": data.get("related_profile_context", []),
            "current_period_context": data.get("current_period_context", {}),
            "explanation_schedule": schedule,
