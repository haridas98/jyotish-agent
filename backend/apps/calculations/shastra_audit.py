...
CALCULATION_SHASTRA_AUDIT: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "source_basis": "Varga-weighted strength across shadvarga, saptavarga, dashavarga and shodasha-varga schemes.",
        "authority_status": "source_backed_with_bphs_caution",
        "implementation_status": "calculated_needs_jhora_audit",
        "review_status": "research_only",
        "public_claim": "weighted_calculation_not_public_interpretation",
        "can_generate_client_interpretation": False,
        "blocker": "Weights and dignity factors need JHora parity plus text/tradition review before public interpretation.",
    },
    {
        "key": "yogas",
    ...
    },
    {
        ...
        "public_claim": "calculated_not_interpretively_verified",
        "can_generate_client_interpretation": False,
        "blocker": "Gulika, Dhuma, Vyatipata, Parivesha, Indrachapa and Upaketu need JHora fixture parity before interpretation.",
    },
    {
        "key": "special_points",
