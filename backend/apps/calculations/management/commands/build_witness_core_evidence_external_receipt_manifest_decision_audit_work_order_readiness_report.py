...
class Command(BaseCommand):
    help = "Build safe non-mutating core witness decision audit work-order readiness report."
    ...
    def handle(self, *args, **options):
        ...
        report = build_witness_core_evidence_external_receipt_manifest_decision_audit_work_order_readiness_report(
            external_receipt_manifest_decision_audit_work_orders_report_path=_resolve(
                root,
                options["external_receipt_manifest_decision_audit_work_orders_report"],
            ),
        )
