...
class Command(BaseCommand):
    help = "Build safe non-mutating core witness decision audit operator handoff smoke matrix report."
    ...
    def handle(self, *args, **options):
        ...
        report = build_witness_core_evidence_external_receipt_manifest_decision_audit_operator_handoff_smoke_matrix_report(
            external_receipt_manifest_decision_audit_work_order_readiness_report_path=_resolve(
                root,
                options["external_receipt_manifest_decision_audit_work_order_readiness_report"],
            ),
        )
