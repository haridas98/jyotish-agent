...
class Command(BaseCommand):
    help = "Build safe non-mutating core witness external evidence receipt gate report."
    ...
    def handle(self, *args, **options):
        ...
        report = build_witness_core_evidence_external_receipt_gate_report(
            external_intake_contract_report_path=_resolve(root, options["external_intake_contract_report"]),
        )
            ...
            json.dumps(
                {
                    ...
                    "case_receipt_gate_rows": report["summary"]["case_receipt_gate_rows"],
                    "attachment_receipt_slot_rows": report["summary"]["attachment_receipt_slot_rows"],
                    "pending_external_evidence_receipt_count": report["summary"][
                        "pending_external_evidence_receipt_count"
                    ],
                    "pending_jhora_receipt_count": report["summary"]["pending_jhora_receipt_count"],
                    "pending_parashara_light_receipt_count": report["summary"][
                        "pending_parashara_light_receipt_count"
                    ],
