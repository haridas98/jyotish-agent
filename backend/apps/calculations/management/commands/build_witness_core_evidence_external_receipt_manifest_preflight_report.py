...
class Command(BaseCommand):
    help = "Build safe non-mutating core witness external evidence receipt manifest preflight report."
    ...
    def handle(self, *args, **options):
        ...
        report = build_witness_core_evidence_external_receipt_manifest_preflight_report(
            external_receipt_manifest_templates_report_path=_resolve(
                root,
                options["external_receipt_manifest_templates_report"],
            ),
        )
            ...
            json.dumps(
                {
                    ...
                    "case_receipt_manifest_preflight_rows": report["summary"][
                        "case_receipt_manifest_preflight_rows"
                    ],
                    "attachment_receipt_manifest_preflight_rows": report["summary"][
                        "attachment_receipt_manifest_preflight_rows"
                    ],
                    "pending_external_evidence_receipt_manifest_preflight_count": report["summary"][
                        "pending_external_evidence_receipt_manifest_preflight_count"
                    ],
                    "pending_jhora_receipt_manifest_preflight_count": report["summary"][
                        "pending_jhora_receipt_manifest_preflight_count"
                    ],
                    "pending_parashara_light_receipt_manifest_preflight_count": report["summary"][
                        "pending_parashara_light_receipt_manifest_preflight_count"
                    ],
