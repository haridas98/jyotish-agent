...
export type WitnessSummary = {
  ...
  witness_core_parity: {
    ...
    target_met: boolean;
    tolerance_profile: Record<string, number>;
    next_actions: Array<{
      case_id: string;
      status: string;
  ...
  witness_strengths_parity: {
    ...
    >;
    target_met: boolean;
    profile_sensitive_layers: string[];
    next_actions: Array<{
      case_id: string;
      status: string;
      checked_layers: string[];
  ...
  witness_yoga_parity: {
    ...
    next_actions: Array<{
      ...
      failed_layers: string[];
      missing_layers: string[];
      checked_yogas: string[];
      matched_yogas: string[];
      failed_yogas: string[];
      missing_yogas: string[];
  ...
  witness_avastha_parity: {
    ...
    next_actions: Array<{
      ...
      failed_layers: string[];
      missing_layers: string[];
      checked_bodies: string[];
      matched_bodies: string[];
      failed_bodies: string[];
      missing_bodies: string[];
      skipped_bodies: string[];
      checked_fields: string[];
      failed_fields: string[];
      missing_fields: string[];
      skipped_fields: string[];
  ...
  witness_compatibility_parity: {
    ...
    next_actions: Array<{
      ...
      failed_layers: string[];
      missing_layers: string[];
      checked_kutas: string[];
      matched_kutas: string[];
      failed_kutas: string[];
      missing_kutas: string[];
      skipped_kutas: string[];
      checked_fields: string[];
      failed_fields: string[];
      missing_fields: string[];
      skipped_fields: string[];
...
export type ChartWorkbenchScope = "d1" | "d2" | "d3" | "d4" | "d7" | "d9" | "d10" | "d12" | "d16" | "d20" | "d24" | "d27" | "d30" | "d40" | "d45" | "d60";
