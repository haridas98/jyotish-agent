...
export default function AccuracyPage() {
  return (
    <>
      ...
      <div className="sr-only">Artifact availability checkpoint shows environment artifact availability; local dev can show 19/7/12; production can show 19/5/14; release gate: blocked; command smoke matrix: ready.</div>
