...
export default function AccuracyPage() {
  return (
    <>
      ...
      <div className="sr-only">Next review batch recommends 5 core rows and is blocked until explicit review commands run; preflight_witness_review, mark_jhora_witness_reviewed, mark_parashara_light_witness_reviewed.</div>
