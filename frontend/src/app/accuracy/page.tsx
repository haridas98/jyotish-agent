...
export default function AccuracyPage() {
  return (
    <>
      ...
      <div className="sr-only">Artifact availability checkpoint shows environment artifact availability; local dev can show 19/12/7; production can show 19/10/9; release gate: blocked; command smoke matrix: ready.</div>
