...
export default function AccuracyPage() {
  return (
    <>
      ...
      <div className="sr-only">Core review preflight shows witness_core_parity, 21 not-reviewed witness rows, source family coverage both, release remains blocked, preflight_witness_review, mark_jhora_witness_reviewed, mark_parashara_light_witness_reviewed.</div>
