    ...
    <section className="panel accuracy-panel" id="accuracy">
      ...
      <div className="accuracy-content">
        <div className="accuracy-list parity-roadmap-ledger">
          ...
          <small>
            {coreEvidencePipeline.stageSequence.join(" - ")}; stage markers: P59 attachment gate - P61 work orders - P63 handoff - P65 operator packets - P67 QA preflight - P69 attachment readiness - P71 external intake contract - P73 external receipt gate - P75 receipt manifest templates - P77 receipt manifest preflight - P79 receipt manifest acceptance gate - P81 receipt manifest decision queue - P83 receipt manifest decision audit - P85 decision audit work orders - P87 work-order readiness - P89 operator handoff smoke matrix; P53 backlog: {coreEvidencePipeline.backlogSummary.blockedRows} blocked, {coreEvidencePipeline.backlogSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.backlogSummary.remainingNotReviewedRows} remaining; P55 intake: {coreEvidencePipeline.intakeSummary.intakeRows} intake rows, {coreEvidencePipeline.intakeSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.intakeSummary.evidenceFilesCommitted} evidence files committed, {coreEvidencePipeline.intakeSummary.remainingNotReviewedRows} remaining; P57 readiness: {coreEvidencePipeline.readinessSummary.readinessRows} readiness rows, {coreEvidencePipeline.readinessSummary.operatorPacketRows} operator packet rows, {coreEvidencePipeline.readinessSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.readinessSummary.blockedRows} blocked, {coreEvidencePipeline.readinessSummary.missingEvidenceSlots} missing evidence slots, {coreEvidencePipeline.readinessSummary.jhoraMissingCount} JHora missing, {coreEvidencePipeline.readinessSummary.parasharaLightMissingCount} Parashara Light missing, {coreEvidencePipeline.readinessSummary.remainingNotReviewedRows} remaining; P83 receipt manifest decision audit: {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.caseReceiptManifestDecisionAuditRows} case receipt manifest decision audit rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.attachmentReceiptManifestDecisionAuditRows} attachment receipt manifest decision audit rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.pendingExternalEvidenceReceiptManifestDecisionAuditCount} pending external evidence receipt manifest decision audit, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.pendingJhoraReceiptManifestDecisionAuditCount} pending JHora receipt manifest decision audit, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.pendingParasharaLightReceiptManifestDecisionAuditCount} pending Parashara Light receipt manifest decision audit, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionQueueRows} decision queue rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionAuditReadyCount} decision audit ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionAuditBlockedCount} decision audit blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionRecordedCount} decisions recorded, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionAuditedCount} decisions audited, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionAuditPassedCount} decision audits passed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.decisionAuditFailedCount} decision audits failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditSummary.remainingNotReviewedRows} remaining; P85 decision audit work orders: {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.caseDecisionAuditWorkOrderRows} case decision audit work-order rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.attachmentDecisionAuditWorkOrderRows} attachment decision audit work-order rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditWorkOrderReadyCount} decision audit work-order ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditWorkOrderBlockedCount} decision audit work-order blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditReadyCount} decision audit ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditBlockedCount} decision audit blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionRecordedCount} decisions recorded, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditedCount} decisions audited, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditPassedCount} decision audits passed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.decisionAuditFailedCount} decision audits failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrdersSummary.remainingNotReviewedRows} remaining; P87 work-order readiness: {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.caseDecisionAuditWorkOrderRows} case decision audit work-order rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.attachmentDecisionAuditWorkOrderRows} attachment decision audit work-order rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.operatorHandoffCasePacketRows} operator handoff case packet rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.operatorHandoffAttachmentPacketRows} operator handoff attachment packet rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionAuditWorkOrderReadyCount} decision audit work-order ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionAuditWorkOrderBlockedCount} decision audit work-order blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.operatorHandoffReadyCount} operator handoff ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.operatorHandoffBlockedCount} operator handoff blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.workOrderDeliveryReadyCount} work-order delivery ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.workOrderDeliveryBlockedCount} work-order delivery blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionRecordedCount} decisions recorded, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionAuditedCount} decisions audited, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionAuditPassedCount} decision audits passed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.decisionAuditFailedCount} decision audits failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditWorkOrderReadinessSummary.remainingNotReviewedRows} remaining; P89 operator handoff smoke matrix: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffCasePacketRows} operator handoff case packet rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffAttachmentPacketRows} operator handoff attachment packet rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffSmokeCaseRows} operator handoff smoke case rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffSmokeAttachmentRows} operator handoff smoke attachment rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.safeValidationCommandFamilyCount} safe validation command families, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.unsafeExternalActionCommandCount} unsafe external action commands, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.commandExecutionPerformedCount} command executions, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.commandSmokeMatrixReadyCount} command smoke matrix ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.commandSmokeMatrixBlockedCount} command smoke matrix blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffReadyCount} operator handoff ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffBlockedCount} operator handoff blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.workOrderDeliveryReadyCount} work-order delivery ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.workOrderDeliveryBlockedCount} work-order delivery blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.decisionRecordedCount} decisions recorded, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.decisionAuditedCount} decisions audited, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.decisionAuditPassedCount} decision audits passed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.decisionAuditFailedCount} decision audits failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.remainingNotReviewedRows} remaining.
          </small>
          <div>
