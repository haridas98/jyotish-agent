...
import { buildArtifactAvailabilityCheckpoint, buildCollectionPlanSnapshotRunbook, buildCoreEvidenceAttachmentGate, buildCoreEvidenceAttachmentHandoff, buildCoreEvidenceAttachmentWorkOrders, buildCoreEvidenceBacklog, buildCoreEvidenceExternalIntakeContract, buildCoreEvidenceExternalReceiptGate, buildCoreEvidenceExternalReceiptManifestAcceptanceGate, buildCoreEvidenceExternalReceiptManifestDecisionAudit, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript, buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix, buildCoreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness, buildCoreEvidenceExternalReceiptManifestDecisionAuditWorkOrders, buildCoreEvidenceExternalReceiptManifestDecisionQueue, buildCoreEvidenceExternalReceiptManifestPreflight, buildCoreEvidenceExternalReceiptManifestTemplates, buildCoreEvidenceIntakePlan, buildCoreEvidenceOperatorPacketAttachmentReadiness, buildCoreEvidenceOperatorPacketQa, buildCoreEvidenceOperatorPackets, buildCoreEvidencePipeline, buildCoreEvidenceReadiness, buildCoreEvidenceUiHandoff, buildCoreReviewBatchScan, buildCoreReviewPreflightBlocker, buildCoreReviewProgress, buildParityCollectionChecklistRows, buildParityCollectionChecklistTotals, buildParityFiniteScopeCheckpoint, buildParityRoadmapRows, buildReleaseGateActionSummary } from "@/lib/parity-roadmap";
...
function AccuracyReportPanel({
  ...
  const parityFiniteScopeCheckpoint = buildParityFiniteScopeCheckpoint(parityRoadmapRows);
  ...
  const coreEvidenceUiHandoff = buildCoreEvidenceUiHandoff();
  ...
  const coreEvidenceExternalReceiptManifestPreflight = buildCoreEvidenceExternalReceiptManifestPreflight();
  const coreEvidenceExternalReceiptManifestAcceptanceGate = buildCoreEvidenceExternalReceiptManifestAcceptanceGate();
  const coreEvidenceExternalReceiptManifestDecisionQueue = buildCoreEvidenceExternalReceiptManifestDecisionQueue();
  const coreEvidenceExternalReceiptManifestDecisionAudit = buildCoreEvidenceExternalReceiptManifestDecisionAudit();
  const coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders = buildCoreEvidenceExternalReceiptManifestDecisionAuditWorkOrders();
  const coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness = buildCoreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate();
  const coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview = buildCoreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview();
    ...
    <section className="panel accuracy-panel" id="accuracy">
      ...
      <div className="accuracy-content">
        <div className="accuracy-list parity-roadmap-ledger">
          ...
          <small>
            Finite JH/PL scope: {parityFiniteScopeCheckpoint.totalRoadmapItems} roadmap items · ready: {parityFiniteScopeCheckpoint.readyRoadmapItems} · review: {parityFiniteScopeCheckpoint.reviewRoadmapItems} · waiting: {parityFiniteScopeCheckpoint.waitingRoadmapItems} · pending/blocked: {parityFiniteScopeCheckpoint.pendingOrBlockedRoadmapItems}; next evidence gate: {parityFiniteScopeCheckpoint.nextEvidenceGate}.
            <span hidden>
              {parityFiniteScopeCheckpoint.stage}; {parityFiniteScopeCheckpoint.status}; {parityFiniteScopeCheckpoint.boundedScopeLabel}; {parityFiniteScopeCheckpoint.totalRoadmapItemsLabel}; {parityFiniteScopeCheckpoint.pendingOrBlockedCountLabel}; {parityFiniteScopeCheckpoint.nextConcreteEvidenceGateLabel}; {parityFiniteScopeCheckpoint.paritySuccessClaimedLabel}; {parityFiniteScopeCheckpoint.releaseReadyLabel}; {parityFiniteScopeCheckpoint.releaseGateStatusLabel}
            </span>
          </small>
          ...
          <p>{coreEvidenceUiHandoff.frontendStage}: South Indian chart UI work active; {coreEvidenceUiHandoff.stage}: {coreEvidenceUiHandoff.statusCopy}; {coreEvidenceUiHandoff.releaseGateStatusLabel}; {coreEvidenceUiHandoff.paritySuccessClaimedLabel}; {coreEvidenceUiHandoff.releaseReadyClaimedLabel}.</p>
          <div>
            <span>product handoff</span>
            <strong>{coreEvidenceUiHandoff.holdReviewBlockedCount}</strong>
            <small>{coreEvidenceUiHandoff.schemaVersion}; parity_micro_chain_capped=true; next_stage_should_be_ui_product_implementation=true; next_stage_recommended_id=E106-A; {coreEvidenceUiHandoff.parityMicroChainCappedLabel}; {coreEvidenceUiHandoff.nextStageUiProductImplementationLabel}; {coreEvidenceUiHandoff.nextStageRecommendedIdLabel}; focus: {coreEvidenceUiHandoff.nextStageRecommendedFocus}; hold-review rows: {coreEvidenceUiHandoff.holdReviewRows}; families: {coreEvidenceUiHandoff.holdReviewFamilyCount}; ready: {coreEvidenceUiHandoff.holdReviewReadyCount}; blocked: {coreEvidenceUiHandoff.holdReviewBlockedCount}; released/dispatched/escalated: {coreEvidenceUiHandoff.holdReviewReleasedCount}/{coreEvidenceUiHandoff.holdReviewDispatchedCount}/{coreEvidenceUiHandoff.holdReviewEscalatedCount}; {coreEvidenceUiHandoff.cautionCopy}.</small>
          </div>
          <details className="accuracy-detail-trail">
            <summary>Audit marker trail</summary>
            <small>
            pipeline latest marker: {coreEvidencePipeline.latestStage}; {coreEvidencePipeline.statusCopy}; release: {coreEvidencePipeline.releaseGateStatus}; command smoke: {coreEvidencePipeline.commandSmokeMatrixStatus}; {coreEvidencePipeline.operatorNote}.
            {coreEvidencePipeline.stageSequence.join(" - ")}; stage markers: P59 attachment gate - P61 work orders - P63 handoff - P65 operator packets - P67 QA preflight - P69 attachment readiness - P71 external intake contract - P73 external receipt gate - P75 receipt manifest templates - P77 receipt manifest preflight - P79 receipt manifest acceptance gate - P81 receipt manifest decision queue - P83 receipt manifest decision audit - P85 decision audit work orders - P87 work-order readiness - P89 operator handoff smoke matrix - P91 safe-validation transcript - P93 safe-validation result ledger - P95 safe-validation result audit - P97 result-audit remediation queue; P53 backlog: {coreEvidencePipeline.backlogSummary.blockedRows} blocked, {coreEvidencePipeline.backlogSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.backlogSummary.remainingNotReviewedRows} remaining; P55 intake: {coreEvidencePipeline.intakeSummary.intakeRows} intake rows, {coreEvidencePipeline.intakeSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.intakeSummary.evidenceFilesCommitted} evidence files committed, {coreEvidencePipeline.intakeSummary.remainingNotReviewedRows} remaining; P57 readiness: {coreEvidencePipeline.readinessSummary.readinessRows} readiness rows, {coreEvidencePipeline.readinessSummary.operatorPacketRows} operator packet rows, {coreEvidencePipeline.readinessSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.readinessSummary.blockedRows} blocked, {coreEvidencePipeline.readinessSummary.missingEvidenceSlots} missing evidence slots, {coreEvidencePipeline.readinessSummary.jhoraMissingCount} JHora missing, {coreEvidencePipeline.readinessSummary.parasharaLightMissingCount} Parashara Light missing, {coreEvidencePipeline.readinessSummary.remainingNotReviewedRows} remaining; P89 operator handoff smoke matrix: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffSmokeCaseRows} operator handoff smoke case rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.operatorHandoffSmokeAttachmentRows} operator handoff smoke attachment rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.safeValidationCommandFamilyCount} safe validation command families, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.commandExecutionPerformedCount} command executions, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.commandSmokeMatrixBlockedCount} command smoke matrix blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrixSummary.remainingNotReviewedRows} remaining; P91 safe-validation transcript: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationTranscriptCaseRows} transcript case rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationTranscriptAttachmentRows} transcript attachment rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationTranscriptCommandRows} transcript command rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationCommandFamilyCount} safe validation command families, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationCommandExecutionPerformedCount} safe validation command executions, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationCommandReadyCount} safe validation command ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.safeValidationCommandBlockedCount} safe validation command blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.operatorHandoffSmokeAttachmentRows} operator handoff smoke attachment rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.unsafeExternalActionCommandCount} unsafe external action commands, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscriptSummary.remainingNotReviewedRows} remaining; P93 safe-validation result ledger: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationTranscriptCaseRows} transcript case rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationTranscriptAttachmentRows} transcript attachment rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationTranscriptCommandRows} transcript command rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationResultLedgerRows} result ledger rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationResultRecordedCount} results recorded, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationResultAcceptedCount} results accepted, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationResultFailedCount} results failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.safeValidationResultBlockedCount} results blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedgerSummary.remainingNotReviewedRows} remaining; P95 safe-validation result audit: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.safeValidationResultAuditRows} result audit rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.safeValidationResultAuditPerformedCount} audits performed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.safeValidationResultAuditPassedCount} audits passed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.safeValidationResultAuditFailedCount} audits failed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.safeValidationResultAuditBlockedCount} audits blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.readyToAttachRows} ready-to-attach, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.readyToMarkRows} ready-to-mark, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditSummary.remainingNotReviewedRows} remaining; P97 result-audit remediation queue: {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationQueueRows} remediation queue rows, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationFamilyCount} remediation families, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationReadyCount} remediation ready, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationBlockedCount} remediation blocked, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationExecutedCount} remediation executed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationTicketCreatedCount} remediation tickets created, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationNotificationSentCount} remediation notifications sent, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationOperatorHandoffDeliveredCount} remediation operator handoffs delivered, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.safeValidationResultAuditRemediationClosedCount} remediation closed, {coreEvidencePipeline.externalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueSummary.remainingNotReviewedRows} remaining.
            </small>
          </details>
          <div>
          ...
          <h3>Core evidence external receipt manifest preflight</h3>
          <p>{coreEvidenceExternalReceiptManifestPreflight.stage}: P77 receipt manifest preflight; {coreEvidenceExternalReceiptManifestPreflight.schemaVersion}; {coreEvidenceExternalReceiptManifestPreflight.statusCopy}.</p>
          <small>
            upstream {coreEvidenceExternalReceiptManifestPreflight.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestPreflight.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestPreflight.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestPreflight.caseReceiptManifestPreflightRows} case receipt manifest preflight rows - {coreEvidenceExternalReceiptManifestPreflight.attachmentReceiptManifestPreflightRows} attachment receipt manifest preflight rows - {coreEvidenceExternalReceiptManifestPreflight.pendingExternalEvidenceReceiptManifestPreflightCount} pending external evidence receipt manifest preflight - {coreEvidenceExternalReceiptManifestPreflight.pendingJhoraReceiptManifestPreflightCount} pending JHora receipt manifest preflight - {coreEvidenceExternalReceiptManifestPreflight.pendingParasharaLightReceiptManifestPreflightCount} pending Parashara Light receipt manifest preflight - {coreEvidenceExternalReceiptManifestPreflight.receiptManifestReceivedCount} receipt manifests received - {coreEvidenceExternalReceiptManifestPreflight.evidenceReceivedCount} evidence received - {coreEvidenceExternalReceiptManifestPreflight.evidenceValidatedCount} validated - {coreEvidenceExternalReceiptManifestPreflight.evidenceFileRecordedCount} file recorded - {coreEvidenceExternalReceiptManifestPreflight.evidenceHashRecordedCount} hash recorded - {coreEvidenceExternalReceiptManifestPreflight.evidenceUploadedCount} uploaded - {coreEvidenceExternalReceiptManifestPreflight.evidenceAttachedCount} attached - {coreEvidenceExternalReceiptManifestPreflight.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestPreflight.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestPreflight.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestPreflight.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestPreflight.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>external receipt manifest preflight status</span>
            <strong>{coreEvidenceExternalReceiptManifestPreflight.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestPreflight.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestPreflight.receiptManifestPreflightStatus}; ${coreEvidenceExternalReceiptManifestPreflight.receiptManifestTemplateStatus}; ${coreEvidenceExternalReceiptManifestPreflight.receiptGateStatus}; ${coreEvidenceExternalReceiptManifestPreflight.intakeStatus}; ${coreEvidenceExternalReceiptManifestPreflight.readinessStatus}; ${coreEvidenceExternalReceiptManifestPreflight.preflightStatusLabel}; ${coreEvidenceExternalReceiptManifestPreflight.receiptManifestReceivedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceReceivedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceValidatedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceUploadedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.evidenceAttachedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestPreflight.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestPreflight.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestPreflight.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestPreflight.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestPreflight.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestPreflight.noEvidenceHashRecordedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>receipt manifest preflight labels</span>
            <strong>{coreEvidenceExternalReceiptManifestPreflight.pendingExternalEvidenceReceiptManifestPreflightCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestPreflight.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestPreflight.safePreflightLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestPreflight.safePreflightFields.join(" - ")}; {coreEvidenceExternalReceiptManifestPreflight.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestPreflight.operatorNote}; {coreEvidenceExternalReceiptManifestPreflight.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest acceptance gate</h3>
          <p>{coreEvidenceExternalReceiptManifestAcceptanceGate.stage}: P79 receipt manifest acceptance gate; {coreEvidenceExternalReceiptManifestAcceptanceGate.schemaVersion}; {coreEvidenceExternalReceiptManifestAcceptanceGate.statusCopy}.</p>
          <small>
            upstream preflight {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestAcceptanceGate.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestAcceptanceGate.caseReceiptManifestAcceptanceGateRows} case receipt manifest acceptance gate rows - {coreEvidenceExternalReceiptManifestAcceptanceGate.attachmentReceiptManifestAcceptanceGateRows} attachment receipt manifest acceptance gate rows - {coreEvidenceExternalReceiptManifestAcceptanceGate.pendingExternalEvidenceReceiptManifestAcceptanceCount} pending external evidence receipt manifest acceptance - {coreEvidenceExternalReceiptManifestAcceptanceGate.pendingJhoraReceiptManifestAcceptanceCount} pending JHora receipt manifest acceptance - {coreEvidenceExternalReceiptManifestAcceptanceGate.pendingParasharaLightReceiptManifestAcceptanceCount} pending Parashara Light receipt manifest acceptance - {coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestReceivedCount} receipt manifests received - {coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestAcceptedCount} receipt manifests accepted - {coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestRejectedCount} receipt manifests rejected - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceReceivedCount} evidence received - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceValidatedCount} validated - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceFileRecordedCount} file recorded - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceHashRecordedCount} hash recorded - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceUploadedCount} uploaded - {coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceAttachedCount} attached - {coreEvidenceExternalReceiptManifestAcceptanceGate.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestAcceptanceGate.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestAcceptanceGate.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestAcceptanceGate.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestAcceptanceGate.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>external receipt manifest acceptance status</span>
            <strong>{coreEvidenceExternalReceiptManifestAcceptanceGate.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestAcceptanceGate.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestAcceptanceStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestPreflightStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestTemplateStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptGateStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.intakeStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.readinessStatus}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.acceptanceGateStatusLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestAcceptanceStatusLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestRejectionStatusLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestReceivedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestAcceptedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.receiptManifestRejectedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceReceivedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceValidatedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceUploadedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.evidenceAttachedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestAcceptanceGate.noMarkCommandExecutedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>receipt manifest acceptance labels</span>
            <strong>{coreEvidenceExternalReceiptManifestAcceptanceGate.pendingExternalEvidenceReceiptManifestAcceptanceCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestAcceptanceGate.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestAcceptanceGate.safeAcceptanceLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestAcceptanceGate.safeAcceptanceFields.join(" - ")}; {coreEvidenceExternalReceiptManifestAcceptanceGate.acceptanceCriteriaLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestAcceptanceGate.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestAcceptanceGate.operatorNote}; {coreEvidenceExternalReceiptManifestAcceptanceGate.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision queue</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionQueue.stage}: P81 receipt manifest decision queue; {coreEvidenceExternalReceiptManifestDecisionQueue.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionQueue.statusCopy}.</p>
          <small>
            upstream acceptance {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionQueue.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionQueue.caseReceiptManifestDecisionQueueRows} case receipt manifest decision queue rows - {coreEvidenceExternalReceiptManifestDecisionQueue.attachmentReceiptManifestDecisionQueueRows} attachment receipt manifest decision queue rows - {coreEvidenceExternalReceiptManifestDecisionQueue.pendingExternalEvidenceReceiptManifestDecisionCount} pending external evidence receipt manifest decision - {coreEvidenceExternalReceiptManifestDecisionQueue.pendingJhoraReceiptManifestDecisionCount} pending JHora receipt manifest decision - {coreEvidenceExternalReceiptManifestDecisionQueue.pendingParasharaLightReceiptManifestDecisionCount} pending Parashara Light receipt manifest decision - {coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestReceivedCount} receipt manifests received - {coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestAcceptedCount} receipt manifests accepted - {coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestRejectedCount} receipt manifests rejected - {coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestDeferredCount} receipt manifests deferred - {coreEvidenceExternalReceiptManifestDecisionQueue.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceReceivedCount} evidence received - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceValidatedCount} validated - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceFileRecordedCount} file recorded - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceHashRecordedCount} hash recorded - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceUploadedCount} uploaded - {coreEvidenceExternalReceiptManifestDecisionQueue.evidenceAttachedCount} attached - {coreEvidenceExternalReceiptManifestDecisionQueue.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionQueue.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionQueue.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionQueue.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestDecisionQueue.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>external receipt manifest decision status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionQueue.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionQueue.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestDecisionStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestAcceptanceStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestPreflightStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestTemplateStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptGateStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.intakeStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.readinessStatus}; ${coreEvidenceExternalReceiptManifestDecisionQueue.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestAcceptanceStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestRejectionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestDeferStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.decisionRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestReceivedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestAcceptedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestRejectedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.receiptManifestDeferredLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.decisionRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceReceivedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceValidatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceUploadedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.evidenceAttachedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionQueue.noMarkCommandExecutedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>receipt manifest decision labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionQueue.pendingExternalEvidenceReceiptManifestDecisionCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionQueue.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionQueue.safeDecisionLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionQueue.safeDecisionFields.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionQueue.decisionCriteriaLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionQueue.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionQueue.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionQueue.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAudit.stage}: P83 receipt manifest decision audit; {coreEvidenceExternalReceiptManifestDecisionAudit.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAudit.statusCopy}.</p>
          <small>
            upstream decision queue {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamDecisionQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamDecisionQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamDecisionQueueStatus} - upstream acceptance {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionAudit.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionAudit.caseReceiptManifestDecisionAuditRows} case receipt manifest decision audit rows - {coreEvidenceExternalReceiptManifestDecisionAudit.attachmentReceiptManifestDecisionAuditRows} attachment receipt manifest decision audit rows - {coreEvidenceExternalReceiptManifestDecisionAudit.pendingExternalEvidenceReceiptManifestDecisionAuditCount} pending external evidence receipt manifest decision audit - {coreEvidenceExternalReceiptManifestDecisionAudit.pendingJhoraReceiptManifestDecisionAuditCount} pending JHora receipt manifest decision audit - {coreEvidenceExternalReceiptManifestDecisionAudit.pendingParasharaLightReceiptManifestDecisionAuditCount} pending Parashara Light receipt manifest decision audit - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionQueueRows} decision queue rows - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditReadyCount} decision audit ready - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditBlockedCount} decision audit blocked - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAudit.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAudit.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAudit.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAudit.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestDecisionAudit.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>external receipt manifest decision audit status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAudit.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAudit.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAudit.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditPassedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAudit.noMarkCommandExecutedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>receipt manifest decision audit labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAudit.pendingExternalEvidenceReceiptManifestDecisionAuditCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAudit.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAudit.safeDecisionAuditLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAudit.safeDecisionAuditFields.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAudit.decisionAuditCriteriaLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAudit.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAudit.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAudit.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit work orders</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.stage}: P85 decision audit work orders; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.statusCopy}.</p>
          <small>
            upstream decision audit {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionAuditSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionAuditStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionAuditStatus} - upstream decision queue {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamDecisionQueueStatus} - upstream acceptance {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.caseDecisionAuditWorkOrderRows} case decision audit work-order rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.attachmentDecisionAuditWorkOrderRows} attachment decision audit work-order rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditWorkOrderReadyCount} decision audit work-order ready - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditWorkOrderBlockedCount} decision audit work-order blocked - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditReadyCount} decision audit ready - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditBlockedCount} decision audit blocked - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>external receipt manifest decision audit work-order status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditPassedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.noExternalTicketCreatedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>decision audit work-order labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.pendingExternalEvidenceDecisionAuditWorkOrderCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.safeDecisionAuditWorkOrderLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.safeDecisionAuditWorkOrderFields.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.decisionAuditWorkOrderCriteriaLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrders.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit work-order readiness</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.stage}: P87 work-order readiness; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.statusCopy}.</p>
          <small>
            upstream work orders {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditWorkOrdersSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditWorkOrdersStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditWorkOrdersStatus} - upstream decision audit {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionAuditStatus} - upstream decision queue {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamDecisionQueueStatus} - upstream acceptance {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.caseDecisionAuditWorkOrderRows} case decision audit work-order rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.attachmentDecisionAuditWorkOrderRows} attachment decision audit work-order rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffCasePacketRows} operator handoff case packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffAttachmentPacketRows} operator handoff attachment packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditWorkOrderReadyCount} decision audit work-order ready - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditWorkOrderBlockedCount} decision audit work-order blocked - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffReadyCount} operator handoff ready - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffBlockedCount} operator handoff blocked - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.workOrderDeliveryReadyCount} work-order delivery ready - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.workOrderDeliveryBlockedCount} work-order delivery blocked - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.releaseGateStatus} - command smoke: {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.commandSmokeMatrixStatus}
          </small>
          <div>
            <span>operator handoff readiness status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.selectedCaseIds.length}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditWorkOrderReadinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditPassedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.decisionAuditFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.readyToAttachLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.readyToMarkLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.noExternalTicketCreatedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>operator handoff readiness labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorHandoffAttachmentPacketRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.safeDecisionAuditWorkOrderReadinessLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.safeDecisionAuditWorkOrderReadinessFields.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditWorkOrderReadiness.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff smoke matrix</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.stage}: P89 operator handoff smoke matrix; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.statusCopy}.</p>
          <small>
            upstream readiness {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrderReadinessSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrderReadinessStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrderReadinessStatus} - upstream work orders {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrdersSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrdersStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditWorkOrdersStatus} - upstream decision audit {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionAuditStatus} - upstream decision queue {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamDecisionQueueStatus} - upstream acceptance {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffCasePacketRows} operator handoff case packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffAttachmentPacketRows} operator handoff attachment packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffSmokeCaseRows} operator handoff smoke case rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffSmokeAttachmentRows} operator handoff smoke attachment rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.safeValidationCommandFamilyCount} safe validation command families - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.unsafeExternalActionCommandCount} unsafe external action commands - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.commandExecutionPerformedCount} command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.commandSmokeMatrixReadyCount} command smoke matrix ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.commandSmokeMatrixBlockedCount} command smoke matrix blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffReadyCount} operator handoff ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffBlockedCount} operator handoff blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.workOrderDeliveryReadyCount} work-order delivery ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.workOrderDeliveryBlockedCount} work-order delivery blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.releaseGateStatus}
          </small>
          <div>
            <span>operator handoff smoke matrix status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffSmokeAttachmentRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditWorkOrderReadinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.commandSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.safeValidationOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.noExternalTicketCreatedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>safe validation families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.safeValidationCommandFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.safeOperatorSmokeLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSmokeMatrix.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation transcript</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.stage}: P91 safe-validation transcript; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.statusCopy}.</p>
          <small>
            upstream smoke matrix {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamOperatorHandoffSmokeMatrixSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamOperatorHandoffSmokeMatrixStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamOperatorHandoffSmokeMatrixStatus} - upstream readiness {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrderReadinessSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrderReadinessStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrderReadinessStatus} - upstream work orders {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrdersSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrdersStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditWorkOrdersStatus} - upstream decision audit {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionAuditStatus} - upstream decision queue {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamDecisionQueueStatus} - upstream acceptance {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamAcceptanceGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamAcceptanceGateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamAcceptanceGateStatus} - upstream preflight {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamPreflightSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamPreflightStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamPreflightStatus} - upstream template {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamTemplateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamTemplateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.upstreamTemplateStatus} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptCaseRows} safe validation transcript case rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptAttachmentRows} safe validation transcript attachment rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptCommandRows} safe validation transcript command rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandFamilyCount} safe validation command families - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandExecutionPerformedCount} safe validation command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandReadyCount} safe validation command ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandBlockedCount} safe validation command blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.unsafeExternalActionCommandCount} unsafe external action commands - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.commandExecutionPerformedCount} command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.commandSmokeMatrixReadyCount} command smoke matrix ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.commandSmokeMatrixBlockedCount} command smoke matrix blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.operatorHandoffReadyCount} operator handoff ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.operatorHandoffBlockedCount} operator handoff blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.workOrderDeliveryReadyCount} work-order delivery ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.workOrderDeliveryBlockedCount} work-order delivery blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.releaseGateStatus}
          </small>
          <div>
            <span>safe validation transcript status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptCommandRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.operatorHandoffSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditWorkOrderReadinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.operatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.commandSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.noExternalTicketCreatedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>safe validation transcript labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.safeValidationTranscriptLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationTranscript.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result ledger</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.stage}: P93 safe-validation result ledger; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.statusCopy}.</p>
          <small>
            upstream transcript {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamSafeValidationTranscriptSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamSafeValidationTranscriptStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamSafeValidationTranscriptStatus} - upstream smoke matrix {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamOperatorHandoffSmokeMatrixSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamOperatorHandoffSmokeMatrixStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.upstreamOperatorHandoffSmokeMatrixStatus} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationTranscriptCaseRows} safe validation transcript case rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationTranscriptAttachmentRows} safe validation transcript attachment rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationTranscriptCommandRows} safe validation transcript command rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultLedgerRows} safe validation result ledger rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandFamilyCount} safe validation command families - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandExecutionPerformedCount} safe validation command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandReadyCount} safe validation command ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandBlockedCount} safe validation command blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultRecordedCount} safe validation results recorded - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultAcceptedCount} safe validation results accepted - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultFailedCount} safe validation results failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultBlockedCount} safe validation results blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffCasePacketRows} operator handoff case packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffAttachmentPacketRows} operator handoff attachment packet rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffSmokeCaseRows} operator handoff smoke case rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffSmokeAttachmentRows} operator handoff smoke attachment rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.unsafeExternalActionCommandCount} unsafe external action commands - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.commandExecutionPerformedCount} command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.commandSmokeMatrixReadyCount} command smoke matrix ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.commandSmokeMatrixBlockedCount} command smoke matrix blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffReadyCount} operator handoff ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffBlockedCount} operator handoff blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.workOrderDeliveryReadyCount} work-order delivery ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.workOrderDeliveryBlockedCount} work-order delivery blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.pendingExternalEvidenceDecisionAuditWorkOrderCount} pending external evidence decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.pendingJhoraDecisionAuditWorkOrderCount} pending JHora decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.pendingParasharaLightDecisionAuditWorkOrderCount} pending Parashara Light decision audit work orders - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionRecordedCount} decisions recorded - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditedCount} decisions audited - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditPassedCount} decision audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditFailedCount} decision audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.releaseGateStatus}
          </small>
          <div>
            <span>safe validation result ledger status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultLedgerRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultLedgerStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultAcceptanceStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultFailureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationTranscriptStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditWorkOrderReadinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.commandSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultLedgerOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noSafeValidationResultRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noSafeValidationResultAcceptedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noSafeValidationResultFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.noExternalTicketCreatedLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>safe validation result families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationCommandFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultLedger.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result audit</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.stage}: P95 safe-validation result audit; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.statusCopy}.</p>
          <small>
            upstream result ledger {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.upstreamSafeValidationResultLedgerSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.upstreamSafeValidationResultLedgerStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.upstreamSafeValidationResultLedgerStatus} - upstream transcript {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.upstreamSafeValidationTranscriptStage} - upstream smoke matrix {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.upstreamOperatorHandoffSmokeMatrixStage} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationTranscriptCaseRows} safe validation transcript case rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationTranscriptAttachmentRows} safe validation transcript attachment rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationTranscriptCommandRows} safe validation transcript command rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultLedgerRows} safe validation result ledger rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditRows} safe validation result audit rows - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandFamilyCount} safe validation command families - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandExecutionPerformedCount} safe validation command executions - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandReadyCount} safe validation command ready - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandBlockedCount} safe validation command blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultRecordedCount} safe validation results recorded - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAcceptedCount} safe validation results accepted - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultFailedCount} safe validation results failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultBlockedCount} safe validation results blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditPerformedCount} safe validation result audits performed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditPassedCount} safe validation result audits passed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditFailedCount} safe validation result audits failed - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditBlockedCount} safe validation result audits blocked - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.readyToAttachRows} ready-to-attach - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.readyToMarkRows} ready-to-mark - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.remainingNotReviewedRows} remaining - release: {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.releaseGateStatus}
          </small>
          <div>
            <span>safe validation result audit status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditPassStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditFailureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultLedgerStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAcceptanceStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultFailureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationTranscriptStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.operatorHandoffSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.decisionAuditWorkOrderReadinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.decisionAuditWorkOrderStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.decisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.decisionQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.receiptGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.intakeStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.readinessStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.receiptManifestStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.decisionAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.workOrderDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.operatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.humanDecisionAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.commandSmokeMatrixStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultLedgerOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultAcceptedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultAuditPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultAuditPassedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSafeValidationResultAuditFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.noExternalTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.releaseGateStatusLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>safe validation result audit labels</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationCommandFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.slotFamilies.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.safeValidationResultAuditFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAudit.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result audit remediation queue</h3>
          <p>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.stage}: P97 result-audit remediation queue; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.statusCopy}.</p>
          <small>
            upstream result audit {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamSafeValidationResultAuditSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamSafeValidationResultAuditStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamSafeValidationResultAuditStatus} - upstream result ledger {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamSafeValidationResultLedgerStage} - upstream transcript {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamSafeValidationTranscriptStage} - upstream smoke matrix {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.upstreamOperatorHandoffSmokeMatrixStage} - safe_validation_transcript_case_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationTranscriptCaseRows} - safe_validation_transcript_attachment_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationTranscriptAttachmentRows} - safe_validation_transcript_command_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationTranscriptCommandRows} - safe_validation_result_ledger_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultLedgerRows} - safe_validation_result_audit_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRows} - safe_validation_result_audit_remediation_queue_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationQueueRows} - safe_validation_result_audit_remediation_family_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationFamilyCount} - safe_validation_result_audit_remediation_ready_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationReadyCount} - safe_validation_result_audit_remediation_blocked_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationBlockedCount} - safe_validation_result_audit_remediation_executed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationExecutedCount} - safe_validation_result_audit_remediation_ticket_created_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationTicketCreatedCount} - safe_validation_result_audit_remediation_notification_sent_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationNotificationSentCount} - safe_validation_result_audit_remediation_operator_handoff_delivered_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationOperatorHandoffDeliveredCount} - safe_validation_result_audit_remediation_closed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationClosedCount} - ready-to-attach rows {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.readyToAttachRows} - ready-to-mark rows {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.readyToMarkRows} - remaining_not_reviewed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.remainingNotReviewedRows} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.releaseGateStatusLabel}
          </small>
          <div>
            <span>result-audit remediation queue status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationQueueRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationTicketStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationNotificationStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationOperatorHandoffStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationClosureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditPassStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditFailureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultLedgerOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationQueueOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAcceptedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditPassedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditFailedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditRemediationExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditRemediationTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditRemediationNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditRemediationOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSafeValidationResultAuditRemediationClosedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noRawValuesInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noPrivatePathsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noSecretsInManifestLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noEvidenceFileRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noEvidenceHashRecordedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.noExternalTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.releaseGateStatusLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>result-audit remediation families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditRemediationFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.remediationFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultAuditFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueue.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result audit remediation queue operator packet</h3>
          <p>E100-A / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.stage}: P99 remediation operator packets; P99 operator-packet readiness; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.statusCopy}.</p>
          <small>
            upstream P99 P97 P95 P93 P91 P89 P87 P85 P83 P81 P79 P77 P75 - upstream remediation queue {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.upstreamRemediationQueueSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.upstreamRemediationQueueStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.upstreamRemediationQueueStatus} - safe_validation_transcript_case_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationTranscriptCaseRows} - safe_validation_transcript_attachment_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationTranscriptAttachmentRows} - safe_validation_transcript_command_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationTranscriptCommandRows} - safe_validation_result_ledger_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultLedgerRows} - safe_validation_result_audit_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRows} - safe_validation_result_audit_remediation_queue_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueRows} - safe_validation_result_audit_remediation_queue_operator_packet_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketRows} - safe_validation_result_audit_remediation_queue_operator_packet_family_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketFamilyCount} - safe_validation_result_audit_remediation_queue_operator_packet_ready_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketReadyCount} - safe_validation_result_audit_remediation_queue_operator_packet_blocked_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketBlockedCount} - safe_validation_result_audit_remediation_queue_operator_packet_delivered_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketDeliveredCount} - safe_validation_result_audit_remediation_queue_operator_packet_acknowledged_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketAcknowledgedCount} - safe_validation_result_audit_remediation_queue_operator_packet_closed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketClosedCount} - safe_validation_result_audit_remediation_queue_operator_packet_executed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketExecutedCount} - remaining_not_reviewed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.remainingNotReviewedRows} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.releaseGateStatusLabel}
          </small>
          <div>
            <span>operator-packet readiness status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketAcknowledgementStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketClosureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRecordStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditPassStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditFailureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationQueueOperatorPacketDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationQueueOperatorPacketAcknowledgedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationQueueOperatorPacketClosedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationQueueOperatorPacketExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noSafeValidationResultAuditRemediationClosedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.noExternalTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.releaseGateStatusLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>operator-packet readiness families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditRemediationQueueOperatorPacketFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.operatorPacketFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.remediationFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultAuditFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacket.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result audit remediation queue operator packet dispatch gate</h3>
          <p>E102-A / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.stage}: P101 operator-packet dispatch gate; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.statusCopy}.</p>
          <small>
            upstream P101 P99 P97 P95 P93 P91 P89 P87 P85 P83 P81 P79 P77 P75 - upstream operator packet {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.upstreamOperatorPacketSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.upstreamOperatorPacketStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.upstreamOperatorPacketStatus} - safe_validation_transcript_case_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationTranscriptCaseRows} - safe_validation_transcript_attachment_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationTranscriptAttachmentRows} - safe_validation_transcript_command_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationTranscriptCommandRows} - safe_validation_result_ledger_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultLedgerRows} - safe_validation_result_audit_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRows} - safe_validation_result_audit_remediation_queue_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueRows} - safe_validation_result_audit_remediation_queue_operator_packet_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketRows} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateRows} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_family_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateFamilyCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_ready_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateReadyCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_blocked_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateBlockedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatched_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_delivered_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateDeliveredCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_acknowledged_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateAcknowledgedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_closed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateClosedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_executed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateExecutedCount} - remaining_not_reviewed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.remainingNotReviewedRows} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.releaseGateStatusLabel}
          </small>
          <div>
            <span>operator-packet dispatch gate status</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateAcknowledgementStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateClosureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateAcknowledgedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateClosedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noSafeValidationResultAuditRemediationClosedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noMarkCommandExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noWorkOrderDeliveryExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noOperatorHandoffDeliveredLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.noExternalTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.releaseGateStatusLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>operator-packet dispatch families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.dispatchGateFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.operatorPacketFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.remediationFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultAuditFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGate.cautionCopy}.</small>
          </div>
          <h3>Core evidence external receipt manifest decision audit operator handoff safe-validation result audit remediation queue operator packet dispatch gate hold review</h3>
          <p>E104-A / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.stage}: P103 dispatch-gate hold review; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.schemaVersion}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.statusCopy}.</p>
          <small>
            upstream P103 P101 P99 P97 P95 P93 P91 P89 P87 P85 P83 P81 P79 P77 P75 - upstream dispatch gate {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.upstreamDispatchGateSchemaVersion} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.upstreamDispatchGateStage} / {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.upstreamDispatchGateStatus} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewRows} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_family_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewFamilyCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_ready_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewReadyCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_blocked_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewBlockedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_released_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewReleasedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_dispatched_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewDispatchedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_hold_review_escalated_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewEscalatedCount} - safe_validation_result_audit_remediation_queue_operator_packet_dispatch_gate_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateRows} - safe_validation_result_audit_remediation_queue_operator_packet_rows={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketRows} - remaining_not_reviewed_count={coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.remainingNotReviewedRows} - {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.releaseGateStatusLabel}
          </small>
          <div>
            <span>dispatch-gate hold review</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewRows}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.selectedCaseIds.map((caseId) => `${caseId}: ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewReleaseStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewDispatchStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewEscalationStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewOnlyLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewReleasedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewDispatchedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewEscalatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateDeliveryStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateAcknowledgementStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateClosureStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateExecutionStatusLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noCommandExecutionPerformedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noUploadExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noAttachmentExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noAcceptExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noRejectExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noDeferExecutedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noExternalNotificationSentLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.noExternalTicketCreatedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.paritySuccessClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.releaseReadyClaimedLabel}; ${coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.releaseGateStatusLabel}`).join(" | ")}</small>
          </div>
          <div>
            <span>hold-review families</span>
            <strong>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReviewFamilyCount}</strong>
            <small>{coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.holdReviewFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.dispatchGateFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.operatorPacketFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.remediationFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultAuditFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.safeValidationResultFamilyLabels.join(" - ")}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.operatorNote}; {coreEvidenceExternalReceiptManifestDecisionAuditOperatorHandoffSafeValidationResultAuditRemediationQueueOperatorPacketDispatchGateHoldReview.cautionCopy}.</small>
          </div>
        </div>
