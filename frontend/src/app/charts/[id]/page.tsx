...
export default function ChartDetailPage() {
  ...
  const model = useMemo(() => {
    ...
    const scopeId = workbench.scope === "d12" ? "D12" : workbench.scope === "d10" ? "D10" : workbench.scope === "d9" ? "D9" : "D1";
  ...
  return (
    <ProductShell active="charts">
      ...
      {model ? (
        <D1ChartWorkbench model={model} status={status} onScopeChange={(nextScope) => setScope(nextScope === "D12" ? "d12" : nextScope === "D10" ? "d10" : nextScope === "D9" ? "d9" : "d1")} />
      ) : (
